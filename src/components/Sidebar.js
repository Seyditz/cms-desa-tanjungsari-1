...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faInbox, faRocket, faUser, faUserCog, faStore } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Tanjung Sari" link={Routes.Presentation.path} image={ReactHero} />

              <NavItem title="Profile" icon={faUserCog} link={Routes.Profile.path} />
              <NavItem title="Users" icon={faUser} link={Routes.Users.path} />
              <NavItem title="Posts" icon={faFileAlt} link={Routes.Posts.path} />
              <NavItem title="UMKM" icon={faStore} link={Routes.Umkm.path} />

              {/* <CollapsableNavItem eventKey="examples/" title="Page Examples" icon={faFile}>
